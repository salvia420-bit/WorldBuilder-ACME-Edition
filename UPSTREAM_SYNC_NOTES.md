...
- **6 ⏳ TODO** (not yet attempted, lower-risk than the deferred set)
...
| B. Weenie / Spell / Monster editor | ~7 commits, new editor surfaces | Med-High | `3457ea7` SpellEditor copy ✅ ported 2026-04-29. Remaining: `4dc3983` (Weenie enums — touches our diverged `DungeonObjectBrowserViewModel.cs` heavily), `d780244`/`55604d2` (spell editor follow-ups; `d780244` likely blocked on `InstancePlacementsPanelView` from `d512ef2`), `239c0c1`/`92fafff`/`d512ef2` (Monster editor + ACE DB instance placements — new editor surfaces). |
