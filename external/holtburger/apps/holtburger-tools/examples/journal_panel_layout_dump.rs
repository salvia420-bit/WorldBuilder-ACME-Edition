// Dump gmJournalUI (LayoutDesc 0x21000066) so the journal-panel plugin
// can confirm element_id → position mapping for the quest list area,
// entry-detail pane, scroll controls, tab buttons, parchment chrome,
// and any decorative frame elements.
...
const JOURNAL_LAYOUT_ID: u32 = 0x21000066;
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let bytes = local.get_file(JOURNAL_LAYOUT_ID)?;
