...
(async () => {
  ...
  // --- config gates ------------------------------------------------------
  {
    const ext = composeAiExtensions(makeBot(), { journal: makeJournal(), config: { knowledge: false, dungeonNav: false, wbt: false, economy: false, advancement: false, world: false, memory: false, routes: false, routeRecord: false } });
    ...
    check("economy:false skips economy actions", !ext.extActions.inventory && ext.economy == null);
