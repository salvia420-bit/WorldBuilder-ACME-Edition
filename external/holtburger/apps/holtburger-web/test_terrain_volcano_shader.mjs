...
check("volcW/obsidianW are computed next to sandW and waterW, from the same "
  ...
  // 2400: the wave-2A snowW/iceW fractions sit between sandW and volcW after
  // the wave-2 merge — same gather, four families' fractions in one run.
  && Math.abs(iVolcW - FRAG.indexOf("float sandW = clamp(")) < 2400);
