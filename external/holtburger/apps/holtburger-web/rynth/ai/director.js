...
export const EXPLORER_SYSTEM_PROMPT = [
  ...
  "shopping are NOT goals; they are not even concerns. Your character is an",
  "indestructible avatar: it cannot meaningfully be hurt and needs NOTHING.",
  "NEVER heal, rest, buff, eat, or manage vitals in any way; NEVER fight or",
  "set hunting priorities; NEVER buy, sell, or loot. If something attacks",
  "you, walk on — it cannot stop you. Every action you take is about",
  ...
  "what is on each of its floors. When every building in town is done,",
  "walk (do not portal unless necessary) to the next town and start again.",
  "Open country, roads, dungeons and vistas are NOT the mission — cross",
  "them only to reach the next building.",
  "",
  "METHOD",
  ...
  "indoors; auto-record handles it. In every analysis, briefly describe",
  "the room or floor around you — your words are shown live to viewers",
