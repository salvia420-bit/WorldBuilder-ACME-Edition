...
- Buffs/debuffs HUD: `client.character.getActiveEnchantments()` returns tiebreak-resolved per-category list. `client.world.addEventListener('enchantmentAdded'|'enchantmentRemoved'|'enchantmentsChanged', …)`.
