...
Usage:
    python scripts/generate_populated_world.py
    python scripts/generate_populated_world.py --model scene_placer_best.safetensors
    python scripts/generate_populated_world.py --temperature 0.9 --top-k 100
"""
...
def generate_world(args):
    ...
    print(f"    python scripts/score_placement_quality.py \"{OUTPUT_SQL}\"")
    print("=" * 72)
