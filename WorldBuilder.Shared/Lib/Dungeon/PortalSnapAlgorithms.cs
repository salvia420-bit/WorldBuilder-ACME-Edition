...
/// <summary>
/// Computes the world transform for a new dungeon cell so that one of its
/// portal polygons aligns flush with a portal polygon on an existing cell.
///
/// Extracted from WorldBuilder.Editors.Dungeon.PortalSnapper — no UI dependencies.
/// All geometry math operates on pure Vector3/Quaternion and CellStruct data.
/// </summary>
public static class PortalSnapAlgorithms {
