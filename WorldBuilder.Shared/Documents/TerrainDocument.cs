...
namespace WorldBuilder.Shared.Documents {
    ...
    public partial class TerrainDocument : BaseDocument {
        ...
        /// <summary>
        /// When true, suppresses per-edit logging and persistence queue updates.
        /// Dirty tracking still works — call ForceSave() after generation to persist.
        /// </summary>
        ...
        /// <summary>
        /// Returns the original, unmodified DAT terrain data for a landblock.
        /// Used by change-detection / diff commands to compare against edits.
        /// </summary>
        public TerrainEntry[]? GetBaseLandblockInternal(ushort lbKey) {
            if (_baseTerrainCache.TryGetValue(lbKey, out var lbTerrain)) {
                return ConvertToTerrainEntries(lbTerrain);
            }
            return null;
        }
        ...
        /// and will be persisted on project save, export, or close. Used for large
        /// imports (heightmaps) to avoid a serialization storm from the save queue.
        /// </summary>
