...
namespace WorldBuilder.Shared.Documents {
    ...
    // Suppress MVVMTK0034: LayerDocument intentionally accesses the _terrainData backing
    // field directly inside lock(_stateLock) blocks and internal mutation paths (Apply,
    // GetLandblockInternal, UpdateLandblocksBatchInternal, CollectEdgeSync) to avoid
    // firing PropertyChanged notifications mid-mutation.
