...
namespace WorldBuilder.Editors.Landscape {
    ...
    public class TerrainDataManager {
        ...
        public float GetHeightAtPosition(float worldX, float worldY) {
            var terrainService = _terrainSystem.Services.GetRequiredService<ITerrainService>();
            return terrainService.GetHeightAtPosition(_terrainSystem.TerrainDoc, _terrainSystem.DocumentManager, _region.LandDefs.LandHeightTable, worldX, worldY);
        }
    }
}