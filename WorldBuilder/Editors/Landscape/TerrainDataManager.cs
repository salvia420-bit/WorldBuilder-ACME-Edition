...
namespace WorldBuilder.Editors.Landscape {
    ...
    public class TerrainDataManager {
        ...
        public float GetHeightAtPosition(float worldX, float worldY) {
            return TerrainAlgorithms.GetHeightAtWorldPosition(worldX, worldY,
                lbId => _terrainSystem.GetLandblockTerrain(lbId),
                _region.LandDefs.LandHeightTable);
        }
        ...
        public static float SampleHeightTriangle(TerrainEntry[] data, float[] heightTable,
            ...
            return TerrainAlgorithms.SampleHeightTriangle(data, heightTable, localX, localY, landblockX, landblockY);
        }

        /// <summary>
        /// Determines the triangle split direction for a terrain cell.
        /// Delegates to TerrainAlgorithms in the shared layer.
        /// </summary>
        public static bool IsSWtoNEcut(uint globalCellX, uint globalCellY) {
            return TerrainAlgorithms.IsSWtoNEcut(globalCellX, globalCellY);
        }
