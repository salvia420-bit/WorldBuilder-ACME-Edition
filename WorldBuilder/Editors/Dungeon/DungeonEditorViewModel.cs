...
namespace WorldBuilder.Editors.Dungeon {
    public partial class DungeonEditorViewModel : ViewModelBase {
        ...
        #region Instance Placements (ACE DB)
        ...
        private async Task TryLoadDbInstancesAsync(ushort landblockKey) {
            ...
            try {
                ...
                foreach (var r in records) {
                    var dungeonLocal = new Vector3(r.OriginX, r.OriginY, r.OriginZ);
        ...
        private void ShowAnalysisResultDialog(WorldBuilder.Shared.Lib.Dungeon.DungeonRoomAnalyzer.AnalysisReport report, string outPath) =>
